...
### Changed
- Extended assistant understanding and capabilities

## [1.15.2+56] - 2026-07-23

### Added
- Simplified Chinese translations

### Changed
- Imrpoved internal database storage

### Fixed
- DPT 20 enum encoding in chat assistant page
...
### Improved
- ETS project parsing speed
- ETS project parsing language English as default for all objects and devices
- Disk memory usage for history of ETS projects

## [1.13.2+51] - 2026-06-12

### Fixed
- KNX IP Secure tunnel connection disconnections after ~30 seconds
- KNX IP Secure reconnection flow

## [1.13.1+50] - 2026-06-11
...
### Changed
- Improved message description on restore purchases explanation
- Improved message description for legacy user pop up dialog
...
### Changed
- Project page scrolling and view behavior
...
### Changed
- Added separate plot view in monitored telegrams, with source bar charts
...
### Fixed
- Removed "Name", in front of building names in project pages
